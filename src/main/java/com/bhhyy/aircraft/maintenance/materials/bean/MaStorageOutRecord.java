...
@Getter
@Setter
@TableName("ma_storage_out_record")
public class MaStorageOutRecord implements Serializable {
     ...
     * 领用人员
     */
    @TableField("material_recipient")
    private String materialRecipient;

    /**
     * 领用时间
     */
    @TableField("recipient_time")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
